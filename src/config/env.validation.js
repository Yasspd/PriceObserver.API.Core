...
function validateEnvironment(config) {
    const validated = {
        ...
        REFRESH_TOKEN_TTL_SECONDS: parseInteger(config.REFRESH_TOKEN_TTL_SECONDS, 604800),
    ...
    process.env.ACCESS_TOKEN_TTL_SECONDS = String(validated.ACCESS_TOKEN_TTL_SECONDS);
    process.env.REFRESH_TOKEN_TTL_SECONDS = String(validated.REFRESH_TOKEN_TTL_SECONDS);
